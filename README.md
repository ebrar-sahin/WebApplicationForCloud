...
ABSTRACT An admin web application for stock receiving, transfers, and pick/pack workflows using ASP.NET Core. 
Use JavaScript for drag-and-drop bin management, CSS for compact data grids, and server-side APIs for inventory 
transactions. Include user-friendly filters, activity logs, and role-based operations. 
INDEX TERMS Warehouse Inventory Web Dashboard, Database Management 
I. 
INTRODUCTION  
...
techniques such as Drag-and-Drop and to implement Enterprise Software Architecture standards in the background. 
II. 
...
JavaScript (AJAX) technologies for dynamic page interactions. 
III. 
...
Dependency Injection (DI), enhancing the system's modularity. 
...
database to provide a role-based authorization infrastructure. 

 <img width="703" height="383" alt="image" src="https://github.com/user-attachments/assets/128cdc8f-5662-4032-97aa-7114939d128f" />
 IV. 
...
messages in the bottom-right corner after every user action. 
V. 
VI. 
CHALLENGES ENCOUNTERED AND SOLUTIONS  
The technical obstacles encountered during the development process served as educational steps 
that provided a deeper understanding of the architecture: 
...
matching the naming conventions in Controller and View layers with the C# models. 
...
Migration files, ensuring database synchronization. 
...
with a clean start. 
USER INTERFACE AND FUNCTIONAL SCREENS (UI/UX) 
...
detailed below. 
1. Security and Access Management (Authentication) 
...
ensuring ease of use with a "Remember Me" option. 
...
via validation messages in case of failed login attempts.
<img width="699" height="368" alt="image" src="https://github.com/user-attachments/assets/66ee1d82-5604-480b-a806-905a125589b0" />
...
background, this screen visualizes critical data via the DashboardViewModel: 
...
manager's attention. 
Supplier Network: The number of active logistics and supplier companies working with the system.
<img width="697" height="365" alt="image" src="https://github.com/user-attachments/assets/dc64950d-4dd3-4348-86f2-57faf67c4365" />
<img width="696" height="364" alt="image" src="https://github.com/user-attachments/assets/ec1fed18-ba5d-471d-9f99-b3dbe269d53b" />
3. Dynamic Stock Management (Kanban Board) 
...
on the input, the stock quantity is calculated mathematically, and the database is updated instantly. 
Instant Notifications: "Toast" notifications appearing in the bottom right corner after every operation immediately inform 
the user about the success status or any errors. 
4. Product Entry and Data Input 
...
database instead of manual entry. 
...
status based on the entered stock quantity, reducing the user's workload.
<img width="693" height="364" alt="image" src="https://github.com/user-attachments/assets/c595d476-0244-4eae-8975-69480bdfdae8" />
5. Activity and Stock History (Audit Logs) 
...
<img width="693" height="362" alt="image" src="https://github.com/user-attachments/assets/ef6d7f40-180e-4b0f-a710-3eb68a352277" />
6. Administrative Tools (Admin Only) 
...
lists on the product entry screen are dynamically populated from this data.
<img width="693" height="364" alt="image" src="https://github.com/user-attachments/assets/00c9b9e7-cb4f-454b-a4ba-b0c5c0bc647a" />
VII. 
CONCLUSION 
