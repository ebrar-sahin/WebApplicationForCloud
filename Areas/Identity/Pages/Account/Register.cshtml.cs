        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // ============================================================
                    //  BAŞLANGIÇ: LOGLAMA KODUNU BURAYA YAPIŞTIRIYORSUN
                    // ============================================================
                    var log = new WebApplication1.Models.ActivityLog
                    {
                        ActionType = "Kullanıcı Eklendi",
                        Description = $"Admin yeni bir kullanıcı oluşturdu: {Input.Email}",
                        LogDate = DateTime.Now
                        // Product_ID null kalabilir
                    };

                    // Eğer _context hata verirse constructor'da tanımlaman gerekir.
                    // Ama hata vermezse burası çalışır.
                    _context.ActivityLogs.Add(log);
                    await _context.SaveChangesAsync();
                    // ============================================================
                    //  BİTİŞ: LOGLAMA KODU BURADA BİTİYOR
                    // ============================================================
                    ...
                    else
                    {
                        ...
                        // Admin paneline (birazdan yapacağız) geri dönsün
